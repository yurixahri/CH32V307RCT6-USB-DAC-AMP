...
[Bill of materials](./Kicad/ch32v307rct6_dac.csv)
...
For TPA6138A2 gain 0db setting, change R18, R19, R12, R15, R14, R20, R24, R26 to 10K ([10.1.1, R1, R2 value](https://www.ti.com/lit/ds/symlink/tpa6138a2.pdf?ts=1786771209908)). With gain 0db, ambient white noise is smaller than gain 6db, which is more comfortable.
